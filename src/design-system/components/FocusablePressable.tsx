...
import { metrics, palette, radius } from '../tokens';
 ...
 * (`onFocus`/`onBlur`). Both drive the same scale animation, so a card or
 * button feels alive whether you tap it or land on it with the d-pad.
 */
